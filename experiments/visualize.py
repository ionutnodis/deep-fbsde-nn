...
# NOTE: price-vs-spot + greeks plotting moved to
# experiments/experimental/greeks_viz.py (unvalidated — commit e39091a).
...
def load_and_visualize(args):
    ...
    # Greeks (BS / BSB only) — experimental, unvalidated (emits UserWarning)
    if args.equation in ["bs", "bsb"]:
        from experiments.experimental.greeks_viz import plot_bs_greeks

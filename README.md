...
<!-- hero figure: regenerated by `python experiments/make_hero_figure.py` before each release,
     then uncomment (absolute raw URL so it renders on the PyPI project page too):
<p align="center"><img src="https://raw.githubusercontent.com/ionutnodis/deep-fbsde-nn/main/docs/assets/hero_bsb_d100.png" width="720" alt="Deep BSDE vs exact solution, d=100"></p>
-->
